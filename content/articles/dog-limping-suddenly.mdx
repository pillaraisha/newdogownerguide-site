...
## How to tell if the limp is serious {#how-serious}
...
## Front leg vs back leg limping {#front-vs-back}
...
## Common causes of sudden limping {#common-causes}
...
## When to see a veterinarian {#when-to-see-vet}
...
## Possible treatment and cost considerations {#treatment-costs}
